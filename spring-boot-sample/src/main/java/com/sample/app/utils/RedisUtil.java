...
public class RedisUtil {
    ...
    private RedisUtil() {
    	if (pool == null) {
            ...
            pool = new JedisPool(config,ReadConfigUtil.getValue("redis.ip"),
            		Integer.parseInt(ReadConfigUtil.getValue("redis.port")),100000,ReadConfigUtil.getValue("redis.password"));
        }
    	
	}
    
    public static void main(String[] args) {
//    	 Map<String, String>  map= hgetall(Constant.REDIS_CAR_YEARS+2006);
