...
-----------------------------------------sharding-databases2
CREATE DATABASE IF NOT EXISTS demo_ds_alibaba;
CREATE DATABASE IF NOT EXISTS demo_ds_baidu;
...
-----------------------------------------master-slave
CREATE DATABASE IF NOT EXISTS demo_ds_master;
CREATE DATABASE IF NOT EXISTS demo_ds_slave_0;
CREATE DATABASE IF NOT EXISTS demo_ds_slave_1;
...
-----------------------------------------sharding-tables
CREATE DATABASE IF NOT EXISTS demo_ds;
